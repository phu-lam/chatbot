      ...
      <div className="content_wapper home_wapper">
        <div className={styles.container_contact}>
          ...
          <div>
            <p >========================================================</p>
            <p>
              <b style={{ fontSize: '20px' }}>Ph&ograve;ng Đ&agrave;o Tạo</b></p>

            <div className={styles.cont}>
              <span><FcHome /></span>
              <div className={styles.loca}>
                <p>  Địa chỉ: 101 Nh&agrave; A1, 268 L&yacute; Thường Kiệt, P. 14, Q.10, Tp. Hồ Ch&iacute; Minh</p>
                <p >
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: '0.5rem', }}>
                <p>
                  Email: <a className={styles.a} href="mailto: pdt@hcmut.edu.vn">pdt@hcmut.edu.vn</a>
                </p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: '0.5rem', }}>
                <p>
                  <a className={styles.a} href="http://aao.hcmut.edu.vn/index.php?route=catalog/chitiettb&thongbao_id=359" target='blank'>Thông tin lãnh đạo phòng đào tạo</a></p>              </div>
            </div>

            <p >========================================================</p>
            <p>
              <b style={{ fontSize: '20px' }}>Phòng Công tác chính trị - Sinh viên</b></p>
            <div className={styles.cont}>
              <span><FcHome /></span>
              <div className={styles.loca}>
                <p>  Địa chỉ: 101A4 Cơ sở Lý thường kiệt hoặc Khu hành chánh Cơ sở Dĩ an</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span><IoIosMail /></span>
              <div style={{ marginLeft: '0.5rem', }}>
                <p>
                  Email: <a className={styles.a} href="mailto: ctctsv@hcmut.edu.vn">ctctsv@hcmut.edu.vn</a>
                </p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <p>
              <p >========================================================</p>
              <p>
                <b style={{ fontSize: '20px' }}>Văn phòng đào tạo quốc tế</b></p>
              <div className={styles.cont}>
                <span><FcHome /></span>
                <div className={styles.loca}>
                  <p>Địa chỉ: Kiosk OISP, Khu B2, Trường Đại học Bách khoa, 268 Lý Thường Kiệt, P.14, Q.10, TP.HCM</p>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <span><IoIosMail /></span>
                <div style={{ marginLeft: '0.5rem', }}>
                  <p>
                    Email: <a className={styles.a} href="mailto: oisp@hcmut.edu.vn">oisp@hcmut.edu.vn</a>
                  </p>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center' }}>
